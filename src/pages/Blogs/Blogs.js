    ...
    return (
        <div className='bg-base-200 min-h-screen'>
            <div className='grid grid-cols-1 gap-10 lg:grid-cols-2 px-10 py-10'>
                <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">To improve the performance of a react application are given-</h2>
                ...
                <div className="card  bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">The four kind of react state to manage</h2>
            ...
            <div className='grid grid-cols-1 gap-10 lg:grid-cols-2 px-10 '>
                <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">The uses of prototypal inheritance is given.</h2>
                ...
                <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">Unit test and its importance is given here</h2>
            ...
            <div className='grid grid-cols-1 gap-10 lg:grid-cols-2 px-10 py-10'>
                <div className="card  bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">Uses of search parameter</h2>
                ...
                <div className="card  bg-base-100 shadow-xl">
                    <div className="card-body">
                        <h2 className="card-title">The reason why we should not update the state directly is-</h2>
