        ...
        <section>
            <div className='mx-10 pt-10'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 '>
                    ...
                    <div class="hero min-h-screen flex justify-starts sm:mb-[-160px]" style={{ background: `url(https://i.ibb.co/KNPHkNW/run-with-us-image-panel.webp)`, backgroundRepeat: 'no-repeat' }}>
